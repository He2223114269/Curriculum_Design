...
def parameter_parser(data_type):
    """
    data_type =  'Email/email-Eu-core','cora/cora'
    ...
    parser.add_argument("--alpha",
                        type=float,
                        default=0.01,
                        help="Regularization parameter. Default is 1.")

    # --cigma：正则化参数（lambda）
    parser.add_argument("--cigma",
                        type=float,
                        default=0.01,
    ...
    parser.set_defaults(layers=[256, 64, 7]) # Email 256, 128, 42 Cora 256, 64, 7
